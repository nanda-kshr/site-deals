...
export default function CartPage() {
  ...
  // Safeguard against undefined Redux state and provide default values
  ...
  const handleCheckout = () => {
    ...
    // Pass item data to checkout; details fetched from Redux
      ...
      <div className="max-w-frame mx-[var(--content-margin)] px-4 xl:px-0">
        {items.length > 0 ? (
          ...
          <div className="flex items-center flex-col text-gray-300 mt-32">
            ...
            <Link href="/shop" className="rounded-full w-24">
              Shop
            </Link>
          </div>
        )}
