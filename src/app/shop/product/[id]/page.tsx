...
const ProductPage = ({ params }: { params: { id: string } }) => {
  ...
  if (loading) {
    return (
      <div className="max-w-frame mx-[var(--content-margin)] px-4 py-8">
  ...
  if (error || !product) {
    return (
      <div className="max-w-frame mx-[var(--content-margin)] px-4 py-8 text-center">
  ...
  const discountedPrice = product.discountPercentage > 0 ? product.price * (1 - product.discountPercentage / 100) : product.price;
  ...
  return (
    <div className="max-w-frame mx-[var(--content-margin)] px-4 py-8 md:py-12">
      <motion.div
