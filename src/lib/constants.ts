...
export const refundPolicy = [
  {
      ...
      content: "Products are eligible for return within 3 days of receipt, but only if explicitly stated as refundable on the product page or in your invoice. To qualify for a return, items must be unused, in their original condition, and include all packaging materials and attached tags."
  },
  {
